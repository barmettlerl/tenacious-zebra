    ...
    Value: Field,
{
    ...
    pub fn execute(
        ...
        let batch = self.0.apply(self.get_name(), batch);
    ...
    ///
    /// let mut database: Database<u32, u32> = Database::new("test");
...
mod tests {
        ...
        Value: Field,
    {
        ...
        /// Check if the tables root node subtree contains the same elements as in reference
